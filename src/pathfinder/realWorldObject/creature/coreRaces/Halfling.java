...
public class Halfling extends Humanoid implements Race
{
	
	private final static AbilityScores abilityScoreModifiers = new AbilityScores(-2,2,0,0,0,2);
	private final static Movement movement = new Movement(20,0,0,0,0,0);
	private final static List<Language> languages = 	Collections.unmodifiableList(Arrays.asList(Language.Common, Language.Halfling));
