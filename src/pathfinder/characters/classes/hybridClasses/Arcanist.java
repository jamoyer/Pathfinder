...
public class Arcanist extends CharacterClass
{
	...
	private static final List<String> SKILLS = Collections
			.unmodifiableList(Arrays.asList(Appraise.NAME, Craft.NAME,
					Fly.NAME, Intimidate.NAME, Arcana.NAME, Dungeoneering.NAME,
					Engineering.NAME, Geography.NAME, History.NAME, Local.NAME,
					Nature.NAME, Nobility.NAME, Planes.NAME, Religion.NAME,
					Linguistics.NAME, Profession.NAME, Spellcraft.NAME,
					UseMagicDevice.NAME));
