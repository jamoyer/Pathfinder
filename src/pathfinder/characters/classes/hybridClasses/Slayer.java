...
public class Slayer extends CharacterClass
{
    public Slayer(int level)
    {
        super(level);
	...
	private static final List<String> SKILLS = Collections
			.unmodifiableList(Arrays.asList(Acrobatics.NAME, Bluff.NAME,
					Climb.NAME, Craft.NAME, Diplomacy.NAME, EscapeArtist.NAME,
					Intimidate.NAME, Local.NAME, Nobility.NAME,
					Perception.NAME, Profession.NAME, Ride.NAME,
					SenseMotive.NAME, SleightOfHand.NAME, Swim.NAME));
