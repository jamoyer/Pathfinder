...
public class Investigator extends CharacterClass
{
	...
	private static final List<String> SKILLS = Collections
			.unmodifiableList(Arrays.asList(Acrobatics.NAME, Appraise.NAME,
					Bluff.NAME, Climb.NAME, Craft.NAME, Diplomacy.NAME,
					DisableDevice.NAME, Disguise.NAME, EscapeArtist.NAME,
					Heal.NAME, Intimidate.NAME, Arcana.NAME,
					Dungeoneering.NAME, Engineering.NAME, Geography.NAME,
					History.NAME, Local.NAME, Nature.NAME, Nobility.NAME,
					Planes.NAME, Religion.NAME, Linguistics.NAME,
					Perception.NAME, Perform.NAME, Profession.NAME,
					SenseMotive.NAME, Spellcraft.NAME, SleightOfHand.NAME,
					Stealth.NAME, UseMagicDevice.NAME));
