...
public class Skald extends CharacterClass
{
	...
	private static final List<String> SKILLS = Collections
			.unmodifiableList(Arrays.asList(Acrobatics.NAME, Appraise.NAME,
					...
					EscapeArtist.NAME, HandleAnimal.NAME, Intimidate.NAME,
					Arcana.NAME, Dungeoneering.NAME, Engineering.NAME,
					Geography.NAME, History.NAME, Local.NAME, Nature.NAME,
					Nobility.NAME, Planes.NAME, Religion.NAME,
					Linguistics.NAME, Perception.NAME, Perform.NAME,
					Profession.NAME, Ride.NAME, SenseMotive.NAME,
					Spellcraft.NAME, Swim.NAME, UseMagicDevice.NAME));
