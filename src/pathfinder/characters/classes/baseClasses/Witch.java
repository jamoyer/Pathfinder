...
public class Witch extends CharacterClass
{
	...
	private static final List<String> SKILLS = Collections
			.unmodifiableList(Arrays.asList(Craft.NAME, Fly.NAME, Heal.NAME,
					Intimidate.NAME, Arcana.NAME, History.NAME, Nature.NAME,
					Planes.NAME, Profession.NAME, Spellcraft.NAME,
					UseMagicDevice.NAME));
