...
public class Summoner extends CharacterClass
{
	...
	private static final List<String> SKILLS = Collections
			.unmodifiableList(Arrays.asList(Craft.NAME, Fly.NAME,
					HandleAnimal.NAME, Linguistics.NAME, Profession.NAME,
					Ride.NAME, Spellcraft.NAME, UseMagicDevice.NAME));
