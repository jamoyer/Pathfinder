...
public class Inquisitor extends CharacterClass
{
	...
	private static final List<String> SKILLS = Collections
			.unmodifiableList(Arrays.asList(Bluff.NAME, Climb.NAME, Craft.NAME,
					Diplomacy.NAME, Disguise.NAME, Heal.NAME, Intimidate.NAME,
					Arcana.NAME, Dungeoneering.NAME, Nature.NAME, Planes.NAME,
					Religion.NAME, Perception.NAME, Profession.NAME, Ride.NAME,
