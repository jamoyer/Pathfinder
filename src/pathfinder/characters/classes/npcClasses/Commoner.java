...
public class Commoner extends CharacterClass
{
    ...
    private static final List<String> SKILLS = Collections.unmodifiableList(Arrays.asList(Climb.NAME, Craft.NAME,
            HandleAnimal.NAME, Perception.NAME, Profession.NAME, Ride.NAME, Swim.NAME));

    private static final List<Proficiency> PROFICIENCIES = Collections.unmodifiableList(new LinkedList<Proficiency>());
