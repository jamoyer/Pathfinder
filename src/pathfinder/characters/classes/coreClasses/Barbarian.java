...
public class Barbarian extends CharacterClass
{
    ...
    private static final List<String> SKILLS = Collections.unmodifiableList(Arrays.asList(Acrobatics.NAME, Climb.NAME, Craft.NAME, HandleAnimal.NAME, Intimidate.NAME, Nature.NAME,
            Perception.NAME, Ride.NAME, Survival.NAME, Swim.NAME));
    ...
    private static final List<Proficiency> PROFICIENCIES = Collections.unmodifiableList(Arrays.asList(Proficiency.SimpleWeapon, Proficiency.MartialWeapon, Proficiency.LightArmor,
            Proficiency.MediumArmor, Proficiency.Shield));
