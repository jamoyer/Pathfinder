...
public class ScreenWriter
{
     ...
     * @param x 0-indexed column number of where to put the character
     * @param y 0-indexed row number of where to put the character in the string
     * @param character Text to put on the screen
     * @param styles Additional styles to apply to the text
     */
    public void drawChar(final int x, final int y, final char character, final ScreenCharacterStyle... styles)
    {
        currentPosition.setColumn(x);
        currentPosition.setRow(y);        
        targetScreen.putC(x, y, character, foregroundColor, backgroundColor, styles);
